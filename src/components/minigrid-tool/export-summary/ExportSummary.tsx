...
interface ExportSummaryProps {
  ...
  onShowEdgeLengthsChange: (_show: boolean) => void;
  onDownloadKml: () => void;
...
export default function ExportSummary({
  ...
  return (
    <div className='space-y-4'>
      {/* Map Display Controls - both checkboxes side-by-side */}
      <div className='rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900/50'>
        <div className='flex flex-wrap items-center gap-x-8 gap-y-4'>
          ...
          <div className='flex items-center gap-3'>
            <input
              type='checkbox'
              id='show-edge-lengths'
              checked={showEdgeLengths}
              onChange={(e) => onShowEdgeLengthsChange(e.target.checked)}
              className='h-5 w-5 rounded border-zinc-300 bg-white text-purple-600 focus:ring-purple-500 dark:border-zinc-600 dark:bg-zinc-800'
            />
            <label
              htmlFor='show-edge-lengths'
              className='cursor-pointer text-sm font-medium text-zinc-700 dark:text-zinc-300'
            >
              Show{' '}
              <span className='font-semibold text-blue-600 dark:text-blue-400'>
          ...
          <div className='space-y-3 border-l border-purple-200 pl-4 dark:border-purple-500/10'>
            <div className='space-y-0.5'>
              ...
              <p>
                ...
                {formatUSD(costBreakdown.usedLowCostPerMeter || lowVoltageCost)}
                /m
              </p>
      ...
      <div className='pt-4'>
        ...
        <div className='flex flex-col gap-3'>
          ...
          <button
            ...
            disabled={computingMiniGrid || savedRunsCount >= 10}
